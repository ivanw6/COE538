...
* Lab 2 Assignment 2                                            *
*                                                               *
* Write a routine to print a text message followed by two       *
* hexadecimal values                                            *
*                                                               *
...
hex1            FCB $69     ; initialize hexadecimal
hex2            FCB $77     ; initialize hexadecimal

mem1            RMB 1       ; initialize and reserve mem1 in 1-byte
mem2            RMB 1       ; initialize and reserve mem2 in 1-byte
mem3            RMB 1       ; initialize and reserve mem3 in 1-byte
mem4            RMB 1       ; initialize and reserve mem4 in 1-byte
mem5            RMB 1       ; initialize and reserve mem5 in 1-byte
